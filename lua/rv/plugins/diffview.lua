return {
  ...
  config = function()
      ...
      keymaps = {
        ...
        view = {
          ...
          },
          {
            ...
            { desc = 'Choose BOTH versions of a conflict' },
          },
          {
            'n',
            '<leader>cB',
    ...
    vim.keymap.set('n', '<leader>dvo', '<cmd>DiffviewOpen<cr>', { desc = 'Open [D]iff[v]iew [O]pen' })
    vim.keymap.set('n', '<leader>dvc', '<cmd>DiffviewClose<cr>', { desc = 'Close [D]iff[v]iew [C]lose' })
    vim.keymap.set('n', '<leader>dvh', '<cmd>DiffviewFileHistory<cr>', { desc = '[D]iff[v]iew File [H]istory' })
    vim.keymap.set('n', '<leader>dvr', '<cmd>DiffviewRefresh<cr>', { desc = '[D]iff[v]iew [R]efresh' })
  end,
}
